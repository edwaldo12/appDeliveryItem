                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" name="price" id="price"
                                            value="{{ old('price') ? old('price') : $good->price }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('supplier_name') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" name="supplier_name" id="supplier_name"
                                            value="{{ old('supplier_name') ? old('supplier_name') : $good->supplier_name }}"
                                            placeholder="Masukkan Harga" required>
                                    ...
                                    <div class="form-group {{ $errors->has('stock') ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" class="form-control" name="stock" id="stock"
                                            value="{{ old('stock') ? old('stock') : $good->stock }}"
                                            placeholder="Masukkan Stok Dalam Pcs" required min="1">
